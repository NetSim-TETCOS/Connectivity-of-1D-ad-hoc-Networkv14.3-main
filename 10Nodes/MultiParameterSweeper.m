...
fprintf(fileid,'X1,X2,X3,X4,X5,X6,X7,X8,X9,X10,Range,Packets Received');
fclose(fileid);

rng('default')
ran_arr = 1000*rand(100,10);
...
for j = 50:50:1000
    ...
    for i = 1:100
        ...
        cmd="ConfigWriter.exe " + string(ran_arr(i,1)) + " "  + string(ran_arr(i,2)) + " " + string(ran_arr(i,3)) + " "  + string(ran_arr(i,4))+ " "+ string(ran_arr(i,5)) + " " + string(ran_arr(i,6)) + " "  + string(ran_arr(i,7)) + " " + string(ran_arr(i,8)) + " "  + string(ran_arr(i,9)) +" "+ string(ran_arr(i,10)) + " " +  string(j);    
        disp(cmd)
        system(cmd);
        ...
        if(isfile('IOPath\Metrics.xml'))
            ...
            if(fileid)
                fprintf(fileid,'\n%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,',ran_arr(i,1),ran_arr(i,2),ran_arr(i,3),ran_arr(i,4),ran_arr(i,5),ran_arr(i,6),ran_arr(i,7),ran_arr(i,8),ran_arr(i,9),ran_arr(i,10),j);
                fclose(fileid);
            end
            ...
            fileid=fopen('result.csv','a');
            if(fileid)
                fprintf(fileid,'\n%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,crash',ran_arr(i,1),ran_arr(i,2),ran_arr(i,3),ran_arr(i,4),ran_arr(i,5),ran_arr(i,6),ran_arr(i,7),ran_arr(i,8),ran_arr(i,9),ran_arr(i,10),j);
                fclose(fileid);
            end
        end
